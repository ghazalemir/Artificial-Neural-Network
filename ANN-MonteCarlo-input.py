...
pd_dat=pd.read_csv('RawData.csv')
...
X_train, X_test, Y_train, Y_test=train_test_split(X_scale[:,:20],dataset[:,20:], test_size=0.2)
...
count1_pre, count2_pre, count3_pre, count4_pre,count5_pre,count6_pre,count7_pre,count8_pre,count9_pre,count10_pre,count11_pre,count12_pre,count13_pre,count14_pre,count15_pre,count16_pre,count17_pre,count18_pre,count19_pre,count20_pre=np.transpose(X_scale_pre)
